...
#[test]
fn add_user_to_channel_success() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_not_logged_in() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_group_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_permission_denied() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_channel_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_user_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_user_not_in_group() {
    let (client, _) = setup!();
...
#[test]
fn add_user_to_channel_user_already_in_channel() {
    let (client, _) = setup!();
...
#[test]
fn get_users_in_channel_not_logged_in() {
    let (client, _) = setup!();
...
#[test]
fn get_users_in_channel_group_does_not_exist() {
    let (client, _) = setup!();
...
#[test]
fn get_users_in_channel_user_not_in_group() {
    let (client, _) = setup!();
...
#[test]
fn get_users_in_channel_channel_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn get_users_in_channel_user_not_in_channel() {
    let (client, _) = setup!();
...
#[test]
fn get_channels_in_group_success() {
    let (client, _) = setup!();
    ...
    assert_eq!(
        response.body_string().unwrap(),
        //this needs improvement
        "[\"test_channel01\",\"test_channel02\"]"
    );
}

#[test]
fn get_channels_in_group_not_logged_in() {
    let (client, _) = setup!();
...
#[test]
fn get_channels_in_group_group_does_not_exist() {
    let (client, _) = setup!();
...
#[test]
fn get_channels_in_group_user_not_in_group() {
    let (client, _) = setup!();
...
#[test]
fn send_message_group_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn send_message_channel_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn send_message_user_not_in_group() {
    let (client, _) = setup!();
...
#[test]
fn send_message_user_not_in_channel() {
    let (client, _) = setup!();
...
#[test]
fn get_messages_group_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn get_messages_user_not_in_group() {
    let (client, _) = setup!();
...
#[test]
fn get_messages_channel_doesnt_exist() {
    let (client, _) = setup!();
...
#[test]
fn get_messages_user_not_in_channel() {
    let (client, _) = setup!();
